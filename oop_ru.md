...
Привет, как дела.  В этой серии видео я обучу ва создавать классы, и как ООП концепция применима
к этому языку. Много чего нужно раскрыть по работе с классами, я собираюсь сделать это
в нескольких видео.
Мы раскроем базу создания инстансов классов, наследование классов и переменных инстанса
статические методы и методы классов, и некоторые другие темы.
